...
class MainWindow(QMainWindow):
    ...
    def create_login_tab(self):
        ...
        # 提示信息
        info = QLabel("请在下方登录页面中使用 Hyperliquid 账户登录\n支持钱包扫码、邮箱登录、API Key 登录")
    ...
    def create_wallet_tab(self):
        ...
        self.address_display.setText("连接成功 - Hyperliquid 账户")
        ...
        eth_box = QGroupBox("账户余额")
        eth_box_layout = QVBoxLayout()
        self.eth_label = QLabel("已连接")
        self.eth_label.setFont(QFont("Arial", 16, QFont.Weight.Bold))
        ...
        self.status_label = QLabel("✅ 已登录 Hyperliquid")
        ...
        balance_layout.addWidget(status_box)
